...
if __name__ == "__main__":
    ...
    if args.filename:
        tp = TranscriptParser()
        tp.process_file(args.file_dir, args.filename, args.save_dir)
    # else:
    #     processor = FileProcessor(file_dir=args.file_dir, save_dir=args.save_dir)
    #     processor.process_all_files()
    #python transcript_parser.py --file-dir "" --save-dir "" --filename "State Street Corporation, Q1 2024 Earnings Call, Apr 12, 2024.rtf"