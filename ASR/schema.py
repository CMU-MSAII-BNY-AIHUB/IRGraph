...
class Statement: # Content in the schema
    def __init__(self, speaker:Person, text, topic="", sentiment="", analysis="", summary="",timeStamp = "", stockPrice=""):
...
class Answer:
    def __init__(self, id, question, speaker, text, topic="", sentiment="", analysis="", emotion="", summary="",timeStamp = "", stockPrice=""):
        self.id = id
