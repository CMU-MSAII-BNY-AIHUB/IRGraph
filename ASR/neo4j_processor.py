    ...
    def main_processor(self, file):
        ...
        def generate_query_to_add_answer(question, neo4j_question_id, parent_question=None):
            ...
            for answer in question.answers:
                ...
                q = 'CREATE (%s: ANSWER {text: "%s", sentiment: "%s", topic: "%s", analysis: "%s", emotion: "%s", summary: "%s", timeStamp: "%s", stockPrice: "%s"}) -[:ANSWER_TO] -> (%s) \n' % \
                (neo4j_answer_id, answer.text, answer.sentiment, answer.topic, answer.analysis, answer.emotion, answer.summary, answer.timeStamp, answer.stockPrice, neo4j_question_id) + \
        ...
        for content in presentation_section.statements:
            q = 'CREATE (%s) -[:HAS_CONTENT]-> (%s:CONTENT {text: "%s", sentiment: "%s", topic: "%s", analysis: "%s", summary: "%s",timeStamp: "%s",stockPrice: "%s"}) \n' \
            % (PRESENTATION_SECTION, make_content_id(content_id), content.text, content.sentiment, content.topic, content.analysis, content.summary, content.timeStamp, content.stockPrice) + \
