    ...
    <div>
      <Dialog size='small' open={welcomeScreenOpen} aria-labelledby='form-dialog-title' disableCloseButton>
        <Dialog.Header id='form-dialog-title'>
          <div>
            BKGraph <NewspaperIconSolid className='icon-base' color='dark-blue' style={{ float: 'right' }} />
            <br />  {/* Add a line break for spacing */}
            <span style={{ fontStyle: 'italic', fontSize: '0.6em' }}>Interactive Knowledge Graph For Earnings Call Transcript Analysis</span>
          </div>
    
        </Dialog.Header>
        <Dialog.Content>
          {/* <Tooltip title='Connect to the BKGraph dashboard.' aria-label='demo' disableInteractive>
            <Button
              target='_blank'
        ...
        >
          <div style={{ color: 'white' }}>
            BKGraph is primarily built using the Neo4j ecosystem. For more information about this tool,{' '}
            <TextLink
              href='https://tinyurl.com/bkgraph-cmu-bnymellon'
              className='n-text-neutral-text-inverse'
              target='_blank'
              style={{ color: 'white' }}
            >
              Visit the BKGraph Website
            </TextLink>
            !
          </div>
        </Dialog.Actions>
