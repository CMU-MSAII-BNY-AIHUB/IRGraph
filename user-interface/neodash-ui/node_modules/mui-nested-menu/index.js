...
const $4bfc6f7ac91dd60d$export$29aa74ef483b19fe = /*#__PURE__*/ (0, $hXhXL$react.forwardRef)(function IconMenuItem({ MenuItemProps: MenuItemProps , className: className , label: label , leftIcon: leftIcon , rightIcon: rightIcon , ...props }, ref) {
    return /*#__PURE__*/ (0, $hXhXL$reactjsxruntime.jsxs)($4bfc6f7ac91dd60d$var$StyledMenuItem, {
        ...
        children: [
            /*#__PURE__*/ (0, $hXhXL$reactjsxruntime.jsxs)($4bfc6f7ac91dd60d$var$FlexBox, {
                children: [
                    leftIcon,
                    /*#__PURE__*/ (0, $hXhXL$reactjsxruntime.jsx)($4bfc6f7ac91dd60d$var$StyledTypography, {
                        children: label
                    })
                ]
            }),
...
const $f5195a18afaf3fe7$export$a49133e888f99d9b = /*#__PURE__*/ (0, $hXhXL$react.forwardRef)(function NestedMenuItem(props, ref) {
    const { parentMenuOpen: parentMenuOpen , label: label , rightIcon: rightIcon = /*#__PURE__*/ (0, $hXhXL$reactjsxruntime.jsx)((0, $e308e62c69875369$export$6172d85aadfc9b96), {}) , leftIcon: leftIcon = null , children: children , className: className , tabIndex: tabIndexProp , ContainerProps: ContainerPropsProp = {} , MenuProps: MenuProps , ...MenuItemProps } = props;
    ...
    const handleFocus = (e)=>{
        if (e.target === containerRef.current) setIsSubMenuOpen(true);
...
function $f6841acb38ae6244$export$fa07f0a23a9d3fdc({ menuItemsData: items , isOpen: isOpen , handleClose: handleClose  }) {
    return items.map((item)=>{
        const { leftIcon: leftIcon , rightIcon: rightIcon , label: label , items: items , callback: callback , sx: sx , disabled: disabled  } = item;
